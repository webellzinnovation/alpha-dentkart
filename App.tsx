...
const QuickReorder = lazy(() => import('./components/QuickReorder').then(m => ({ default: m.QuickReorder })));
const GuestCheckout = lazy(() => import('./components/GuestCheckout').then(m => ({ default: m.GuestCheckout })));
