...
exports.sendOrderStatusNotification = exports.sendTrackingNotification = exports.sendCustomNotification = void 0;
...
const sendCustomNotification = async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to send custom notification email:', error);
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
        ...
        const info = await transporter.sendMail(mailOptions);
        logger_1.default.info(`Tracking notification sent to ${to} for order ${orderId}`);
...
exports.sendTrackingNotification = sendTrackingNotification;
...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
        ...
        const info = await transporter.sendMail(mailOptions);
        logger_1.default.info(`Order status notification sent to ${to} for order ${orderId}: ${orderStatus}`);
        res.json({ success: true, message: 'Order status notification sent successfully', messageId: info.messageId });
    }
    catch (error) {
        logger_1.default.error('Failed to send order status notification:', error);
