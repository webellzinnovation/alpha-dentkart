...
import { sendCustomNotification } from '../../controllers/notificationsController';
...
describe('notificationsController', () => {
  ...
  describe('sendCustomNotification', () => {
    it('handles success case successfully', async () => {
      const { req, res } = mockReqRes({}, { title: 'hello', body: 'world' });
      ...
      try {
        await sendCustomNotification(req, res);
      } catch (e) {}
