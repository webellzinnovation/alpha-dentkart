...
import { calculateDeliveryEstimation } from '../../controllers/deliveryEstimationController';
...
describe('deliveryEstimationController', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  describe('calculateDeliveryEstimation', () => {
    it('handles success case successfully', async () => {
      ...
      try {
        await calculateDeliveryEstimation(req, res);
      } catch (e) {}
