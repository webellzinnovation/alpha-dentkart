...
import { createPromotionalTile } from '../../controllers/promotionalTileController';
...
describe('promotionalTileController', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  describe('createPromotionalTile', () => {
    it('handles success case successfully', async () => {
      ...
      try {
        await createPromotionalTile(req, res);
      } catch (e) {}
