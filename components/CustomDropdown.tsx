...
export const CustomDropdown: React.FC<CustomDropdownProps> = ({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={`absolute z-50 min-w-full w-56 mt-1 bg-white dark:bg-surface-dark border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl max-h-60 overflow-y-auto animate-fade-in whitespace-nowrap flex flex-col ${align === 'right' ? 'right-0' : 'left-0'}`}>
