    ...
    <div onClick={handleClick} className="premium-card p-3 flex flex-col h-full bg-white dark:bg-surface-dark group cursor-pointer">
      ...
      <div className="flex justify-between items-start mb-2">
        ...
        <button
          ...
          className={`w-8 h-8 rounded-xl shadow-sm flex items-center justify-center transition-all ${isInWishlist ? 'bg-gradient-brand text-white shadow-md shadow-primary/30' : 'bg-gray-100/80 dark:bg-gray-800/80 text-gray-400 hover:text-primary hover:bg-white dark:hover:bg-gray-700'}`}
        >
      ...
      {/* Product Image Area */}
      <div className="relative aspect-square flex items-center justify-center bg-gradient-to-b from-gray-50/80 to-gray-100/30 dark:from-gray-900/80 dark:to-gray-800/30 rounded-2xl overflow-hidden mb-3 border border-gray-100/50 dark:border-gray-800/50">
        <OptimizedImageMemo
        ...
        <div className="mt-auto flex items-center justify-between gap-2">
          ...
          {product.stock === 0 ? (
            <button
              ...
              className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${isSubscribed ? 'bg-emerald-500 text-white' : 'bg-orange-100 text-orange-600'}`}
            >
            ...
            <button
              ...
              className="w-10 h-10 rounded-xl bg-gradient-brand text-white shadow-lg shadow-primary/25 hover:shadow-primary/40 flex items-center justify-center active:scale-90 hover:scale-105 transition-all"
            >
