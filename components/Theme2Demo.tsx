...
import { HomePage } from '../themes/theme-2-service-style/pages/HomePage';
import { Product } from '../types';

// Sample products for Theme 2 demo
...
export const Theme2Demo: React.FC = () => {
    ...
    return (
        <div className="min-h-screen">
            {/* Demo Banner */}
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3 px-4 text-center sticky top-0 z-50 shadow-lg">
                <div className="flex items-center justify-center gap-3">
                    <i className="fas fa-eye"></i>
                    <span className="font-semibold">Theme 2 Preview: Service Style</span>
                    <button
