...
async function backfillKeywords() {
    ...
    const productsSnapshot = await firebase_1.db.collection('products').get();
    ...
    for (const doc of productsSnapshot.docs) {
        try {
            ...
            const keywords = (0, generateKeywords_1.generateKeywords)(`${name} ${brand} ${category} ${description}`);
...
//# sourceMappingURL=backfillKeywords.js.map